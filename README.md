...
<br/>
<div align="center">
  <img width="30%" src="./res/mobile-medicine.png" alt="medicine-search"/>
  <img width="30%" src="./res/mobile-medicine-search.png" alt="medicine-search"/>
  <img width="30%" src="./res/mobile-medicine-detail.png" alt="medicine-detail"/>
  <p>Medicine Search Screen</p>
</div>
<br/>
<div align="center">
  <img width="30%" src="./res/mobile-scan-prescript.png" alt="mobile-scan-prescript"/>
  <img width="30%" src="./res/mobile-add-prescript.png" alt="mobile-add-prescript"/>
  <img width="30%" src="./res/mobile-remind.png" alt="mobile-remind"/>
  <p>Medicine Prescription Screen</p>
</div>
<br/>
<div align="center">
  <img width="30%" src="./res/mobile-purchase.png" alt="mobile-purchase"/>
  <img width="30%" src="./res/mobile-payment.png" alt="mobile-payment"/>
  <img width="30%" src="./res/mobile-customerinfo.png" alt="mobile-customerinfo"/>
