...
import 'package:pillpalmobile/common/convert_time.dart';
import 'package:pillpalmobile/constants.dart';
import 'package:pillpalmobile/global_bloc.dart';
import 'package:pillpalmobile/model/errors.dart';
...
import 'package:pillpalmobile/screens/home/success_screen/success_screen.dart';
import 'package:pillpalmobile/utils/rive_utils.dart';
import 'package:provider/provider.dart';
import 'package:sizer/sizer.dart';

class AutoEntryPage extends StatefulWidget {
  var nameMedicine;
  var lieudung;
  var buoi;
  AutoEntryPage({Key? key, this.nameMedicine, this.lieudung, this.buoi})
      : super(key: key);
  @override
  State<AutoEntryPage> createState() => _AutoEntryPageState();
}

class _AutoEntryPageState extends State<AutoEntryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    nameController.text = widget.nameMedicine.toString();
    //dosageController.text = widget.lieudung.toString();
    dosageController.text = 1.toString();

    return Scaffold(
      key: _scaffoldKey,
      resizeToAvoidBottomInset: false,
      appBar: AppBar(
        title: const Text("Mời bạn kiểm tra lại thông tin"),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SelectTime(buoitmp: widget.buoi),
              SizedBox(
                height: 2.h,
              ),
              Padding(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      ...
                      Medicine newEntryMedicine = Medicine(
                          ...
                          medicineName: widget.nameMedicine,
                          dosage: 1,
...
class SelectTime extends StatefulWidget {
  var buoitmp;
  SelectTime({Key? key, this.buoitmp}) : super(key: key);
...
class _SelectTimeState extends State<SelectTime> {
  late TimeOfDay _time = const TimeOfDay(hour: 20, minute: 30);

  // @override
  // void initState() {
  //   super.initState();
  //   if (3 > widget.buoitmp) {
  //     _time = const TimeOfDay(hour: 6, minute: 00);
  //   }
  //   if ((6 > widget.buoitmp && widget.buoitmp > 2)) {
  //     _time = const TimeOfDay(hour: 12, minute: 00);
  //   }
  //   if ((9 > widget.buoitmp && widget.buoitmp > 5)) {
  //     _time = const TimeOfDay(hour: 17, minute: 00);
  //   } else {
  //     _time = const TimeOfDay(hour: 0, minute: 00);
  //   }
  // }
